...
import { GroupListTable } from "../../../../components/dashboard/team/team-group-table";
...
const GroupList = () => {
  ...
  return (
    <>
      <Head>
        <title>Dashboard: Team Group List | Material Kit Pro</title>
      </Head>
      <Box
        component="main"
        sx={{
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">Team Groups</Typography>
              </Grid>
              <Grid item>
              <Link
              href={'/dashboard/teams/groups/add'}
              >
                <Button
          ...
          <Card>
            ...
            <GroupListTable
              group={paginatedCustomers}
              groupCount={filteredCustomers?.length}
