...
import { CompetencyListTable } from "../../../../components/dashboard/competencies/competency-parameters-table";
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              <Grid item>
                <Typography variant="h4">Competency Parameters</Typography>
              </Grid>
              <Grid item>
              <Link
              href={'/dashboard/competencies/parameters/add'}
              >
                <Button
