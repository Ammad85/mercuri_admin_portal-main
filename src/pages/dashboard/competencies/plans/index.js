...
import { CompetencyListTable } from "../../../../components/dashboard/competencies/competency-plans-table";
...
const CompetencyList = () => {
  ...
  const getUsersForCompany = async () => {
    let response =[]
    await axiosClient
      .get("Competency/getCompetencyPlans?companyId=1", {})
      .then((res) => {
        response = res.data;
      })
      .catch((err) => {
        ...
        <Container maxWidth="xl">
          <Box sx={{ mb: 4 }}>
            <Grid container justifyContent="space-between" spacing={3}>
              ...
              <Grid item>
              <Link
              href={'/dashboard/competencies/plans/add'}
              >
                <Button
